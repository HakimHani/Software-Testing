...
def calculate_performance(training_data_file, testing_data_file):
    ...
    # random_f = RandomForestClassifier(max_depth=10, random_state=0)
    random_f = RandomForestClassifier(n_estimators=100, criterion='gini', max_depth=10, min_samples_split=2, min_samples_leaf=1, min_weight_fraction_leaf=0.0, max_features='auto', max_leaf_nodes=None, min_impurity_decrease=0.0, min_impurity_split=None, bootstrap=True, oob_score=False, n_jobs=None, random_state=None, verbose=0, warm_start=False, class_weight=None, ccp_alpha=0.0, max_samples=None)
    test_pred = random_f.fit(train_data, train_target).predict(test_data)
